...
use super::helper_constraints::poseidon::{
    PoseidonParams, Poseidon_hash_2, Poseidon_hash_2_gadget,
    Poseidon_hash_4, Poseidon_hash_4_gadget,
    Poseidon_hash_8, Poseidon_hash_8_gadget,
    SboxType, PADDING_CONST, ZERO_CONST,
};
...
mod tests {
    ...
    fn check_hash_2(hash_params: &PoseidonParams, sbox_type: &SboxType) {
        ...
        .unwrap();
        println!("Proving time for Poseidon 2:1 with sbox {:?} is: {:?}", sbox_type, start.elapsed());
    ...
    fn check_hash_4(hash_params: &PoseidonParams, sbox_type: &SboxType) {
        ...
        let inputs = [FieldElement::random(), FieldElement::random(), FieldElement::random(), FieldElement::random()];
        ...
        let (proof, commitments) = gen_proof_of_knowledge_of_preimage_of_Poseidon_4(
            ...
            .unwrap();
        println!("Proving time for Poseidon 4:1 with sbox {:?} is: {:?}", sbox_type, start.elapsed());
    ...
    fn check_hash_8(hash_params: &PoseidonParams, sbox_type: &SboxType) {
        ...
        let inputs = [FieldElement::random(), FieldElement::random(), FieldElement::random(), FieldElement::random(),
            FieldElement::random(), FieldElement::random(), FieldElement::random(), FieldElement::random()];
        ...
        let (proof, commitments) = gen_proof_of_knowledge_of_preimage_of_Poseidon_8(
            ...
            .unwrap();
        println!("Proving time for Poseidon 8:1 with sbox {:?} is: {:?}", sbox_type, start.elapsed());

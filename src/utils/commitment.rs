...
pub fn commit_to_field_element(g: &G1, h: &G1, elem: &FieldElement,
                               r: &FieldElement) -> G1 {
...
pub fn commit_to_field_element_vectors(g: &GroupElementVector, h: &GroupElementVector, u: &G1,
                                       a: &FieldElementVector, b: &FieldElementVector, c: &FieldElement) -> Result<G1, ValueError> {
